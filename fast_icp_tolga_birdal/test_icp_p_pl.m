...
tic ();
%[Pose]=icp_mod_point_plane_pyr(SrcPC, SrcN, DstPC, DstN, Tolerance, MaxIterations, RejectionScale, NumNeighborsCorr, NumLevels, SampleType, DrawRegistration)
%FinalPose = icp_mod_point_plane_pyr(SrcPC, SrcN, DstPC, DstN, 0.02, 200, 3, 1, 8, 0, 1);
FinalPose = icp_mod_point_plane_pyr(SrcPC, SrcN, DstPC, DstN, 0.02, 200, 3, 1, 8, 0, 0);
toc();

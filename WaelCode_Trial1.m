...
[neck_loc, neck_location_images] = Find_Neck_Location(root,calibration_dir);
%% generate the focal grid
find_focal_grid_WS_v1(calibration_dir,neck_loc,neck_location_images)
%% creates background
...
%a single point which will be used for reference
        ...
        neck_location_images=[Neck_Position_1 1 ; Neck_Position_2 1; Neck_Position_3 1];
    end

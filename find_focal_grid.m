...
%what are RW_1 2 3
    RW_1 = return_rot_mat(calib_par_cam_1);
...
function [vox_1_mat, vox_2_mat, vox_3_mat, P_vox, P_vox_neighbor] = calculate_focal_grid(e1,e2,e3,P1,P2,P3,wing_hinge_center)
    ...
    voxel_size = 0.040; %this should be in mm?
...
%     Z_grid_trans = 0;
    ...
    P_vox = [reshape(X_grid,1,257^3); reshape(Y_grid,1,257^3); reshape(Z_grid,1,257^3)]; % consider replacing 257 with size of each array
